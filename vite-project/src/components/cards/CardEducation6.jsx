...
import Educantion6 from "../../assets/img/Education6.png"

const CardEducation6 = () => {
    return (
        <div class="cardE">
          <div class="cardE-image">
            <img src={Educantion6} alt="Education" className="card-image" />
          </div>
