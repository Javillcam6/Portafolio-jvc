...
import Educantion9 from "../../assets/img/Education9.png"

const CardEducation9 = () => {
    return (
        <div class="cardE">
          <div class="cardE-image">
            <img src={Educantion9} alt="Education" className="card-image" />
          </div>
